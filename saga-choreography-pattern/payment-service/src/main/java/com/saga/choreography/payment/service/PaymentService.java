...
import com.saga.choreography.common.event.OrderEvent;
import com.saga.choreography.common.event.PaymentEvent;
...
import com.saga.choreography.payment.repository.UserBalanceRepository;
import com.saga.choreography.payment.repository.UserTransactionRepository;
...
public class PaymentService {
    ...
    // if balance sufficient ---> Payment completed & deduct amount from DB
    // if payment not sufficient --> cancel the order event & update the amount in DB
    @Transactional
    public PaymentEvent newOrderEvent(OrderEvent orderEvent) {
        ...
        return userBalanceRepository.findById(orderRequestDto.getUserId())
                ...
                .map(ub -> {
                    ...
                    userTransactionRepository.save(new UserTransaction(orderRequestDto.getUserId(), orderRequestDto.getUserId(), orderRequestDto.getAmount()));
